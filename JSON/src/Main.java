...
/* Parte II: Añade un campo int edad a la clase llamada Usuario y por tanto, modifica el JSON.
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        //Usuario user2 = mapper.readValue(new File("JSON/src/javausuario.json"), Usuario.class);
        ...
        for (Usuario u : usuarios) {
            System.out.println("Usuario/s leído/s desde .JSON: " + u);
        }
    }
}